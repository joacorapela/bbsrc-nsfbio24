...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item lasting 2 weeks and recording behaviour only
            \item lasting 27 hours and recording behaviour and electrophysiology
        ...
        \item the AIND is setting up odour exploration experiments that
            will last several days.

        \item  items 1--2: above have been completed for the SWC foraging experiments

        \item item 3: the SWC has developed some quality control software for behaviour.

        \item item 4: alerts have been developed for behaviour and electrophysiology.
        }
        \only<2>{
      ...
      analysis:
        ...
        \item  disseminated documentation on machine learning methods integrated
            into Bonsai for analysing behavioural and neural time series in real time
